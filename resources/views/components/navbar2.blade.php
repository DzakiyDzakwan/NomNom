    ...
    <nav class="fixed inset-0 z-20 py-5 px-32 bg-white shadow-xl md:flex md:items-center md:justify-between h-[72px]">
        <div class="flex items-center ">
            <span class="text-2xl font-[Poppins] cursor-pointer">
                <img class="h-10 inline static md:w-[210px] md:h-[48px]" src="{{ asset('assets/images/logo/400x100.png') }}">
            </span>
                    ...
                    <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefault">
                        ...
                        <li class="flex px-4 py-2">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14" class="w-4 h-4">
                                <g>
                                    <path d="M7,13.5A6.5,6.5,0,0,0,13.5,7H.5A6.5,6.5,0,0,0,7,13.5Z" fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round"></path>
                                    <line x1="7.5" y1="5" x2="10.5" y2="0.5" fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round"></line>
                                    <line x1="9" y1="5.5" x2="12.5" y2="2.5" fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round"></line>
                                </g>
                            </svg>
                        ...
                        <li class="flex px-4 py-2">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14" class="w-4 h-4">
                                <g>
                                    ...
                                    <polygon points="13.5 8.5 8.79 13.21 6.66 13.5 6.96 11.37 11.66 6.66 13.5 8.5" fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round"></polygon>
                                </g>
                            </svg>
                        ...
                        <li class="flex px-4 py-2">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14" class="w-4 h-4">
                                <g>
                                    ...
                                    <line x1="4.5" y1="11.5" x2="13.5" y2="11.5" fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round"></line>
                                </g>
                            </svg>
                        ...
                        <li class="flex px-4 py-2">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14" class="w-4 h-4">
                                <g>
                                    ...
                                    <polyline points="11.5 5 13.5 7 11.5 9" fill="none" stroke="#000000" stroke-linecap="round" stroke-linejoin="round"></polyline>
                                </g>
                            </svg>
