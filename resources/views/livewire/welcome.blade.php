        ...
        <section class="text-gray-600 mt-[72px] mb-12">
            <div class="container mx-auto flex px-24 md:flex-row flex-col items-center relative">
                    ...
                    <form class="flex items-center">
                        ...
                        <div class="relative">
                            <input type="text" id="simple-search"
                                class="bg-transparent backdrop-blur-sm text-main border border-main shadow-sm text-base font-medium focus:ring-blue-500 focus:border-blue-500 block w-[300px] h-[40px] md:w-[360px] pl-10 p-2.5 rounded-lg"
                ...
                <div class="w-[553px] h-[550px] hover:scale-105 transition ease-in-out duration-1000 mt-[12px]">
                    <img class="object-cover object-center drop-shadow-xl" alt="hero"
