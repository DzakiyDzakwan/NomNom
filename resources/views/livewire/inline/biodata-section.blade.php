<div>
    <section class="bg-[#383838] text-white h-[323px]">
        <div class="max-w-screen-xl px-4 py-10">
          <div class="max-w-xl ml-32 relative">
            <div class="md:w-[179px] md:h-[179px]">
                ...
                <button class="h-10 w-10 fixed bg-white ml-36 top-52 rounded-full border-solid border-2 border-[#FFB03E] px-2">
