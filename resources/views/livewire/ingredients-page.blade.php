    ...
    <section class="container px-24 mt-12 mx-auto">
        ...
        <div class="grid lg:grid-cols-2 md:grid-cols-2 sm:grid-cols-1 gap-4 mt-12">
            ...
            <div class="border border-2 border-[#FFB03E] rounded-2xl px-3.5 py-3.5">
                ...
                <a
                class="inline-flex items-center gap-1 rounded-full border-2 border-[#FFB03E] bg-transparent px-2 py-0.5 text-base font-medium text-gray-800 transition-colors hover:bg-[#FFB03E] hover:text-white focus:outline-none focus:ring active:opacity-75" href="#" rel="noreferrer">
                Telur
