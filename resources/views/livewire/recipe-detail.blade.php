        ...
        <div class="py-6 basis-3/5 pr-6 mr-4">
            ...
            <div class="flex mt-6 space-x-4 items-center">
                <svg fill="#000000" height="24px" width="24px" version="1.1" id="Layer_1"
                    ...
                    <g id="SVGRepo_iconCarrier">
                        <g>
                            <g>
                                <path
                                    d="M314.801,290.806l-34.999-34.998l25.837-25.837c14.577,9.805,31.487,14.722,48.404,14.722 c22.222,0,44.444-8.458,61.36-25.375l96.599-96.599l-23.609-23.609l-74.721,74.721l-9.428-9.428l74.721-74.721l-23.609-23.61 l-74.721,74.721l-9.429-9.429l74.721-74.721l-23.609-23.609l-74.721,74.721l-9.429-9.429l74.721-74.721L389.282,0l-96.599,96.598 c-16.39,16.39-25.416,38.181-25.416,61.36c0,12.172,2.512,23.952,7.251,34.779l-89.307-89.307 c-35.535-35.535-86.43-52.353-136.136-44.984c-11.936,1.768-21.702,9.984-25.487,21.441c-3.785,11.456-0.837,23.875,7.695,32.406 l172.408,172.408l-6.53,6.53l-28.805-28.806L0.001,430.781l81.221,81.221l168.354-168.354l-28.806-28.806l35.423-35.423 l34.999,34.999l-28.806,28.806L430.74,511.577l81.219-81.221L343.607,262.001L314.801,290.806z">
                                </path>
                            </g>
                        </g>
                    </g>
                ...
                <span class="inline-flex -space-x-px overflow-hidden rounded-md border bg-white shadow-sm">
                    <button
                        class="inline-block px-6 py-2 text-sm font-bold text-gray-700 hover:bg-gray-50 focus:relative">
                        -
                    </button>
